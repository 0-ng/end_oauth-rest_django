...
import {
  ...
  IntlShape,
  MessageDescriptor,
} from 'C:/dockerProject/end/backend/oauth-rest_django/tyadmin/node_modules/react-intl';
import { ApplyPluginsType } from 'umi';
import { event, LANG_CHANGE_EVENT } from './locale';
// @ts-ignore
import warning from 'C:/dockerProject/end/backend/oauth-rest_django/tyadmin/node_modules/warning/warning.js';

import { plugin } from '../core/umiExports';

export * from 'C:/dockerProject/end/backend/oauth-rest_django/tyadmin/node_modules/react-intl';
...
export const localeInfo: {[key: string]: any} = {
  'en-US': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('C:/dockerProject/end/backend/oauth-rest_django/tyadmin/src/locales/en-US.js')),
    },
    locale: 'en-US',
    antd: {
  ...
  'zh-CN': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('C:/dockerProject/end/backend/oauth-rest_django/tyadmin/src/locales/zh-CN.js')),
    },
    locale: 'zh-CN',
    antd: {
